...
<body>
    ...
    <div class="container">
        <?php 
            $sql = "SELECT * FROM pizabites_signup WHERE id='$userId'"; 
        ...
        <div class="row">
            <div class="jumbotron p-3 mb-3" style="display: flex;justify-content: center;width: 28%;border-radius: 50px;margin: 0 auto;">
                <div class="user-info">
                    ...
                    <form action="_manageProfile.php" method="POST">
                    ...
                    <form action="_manageProfile.php" method="POST" enctype="multipart/form-data" style="margin-top: 7px;">
                    ...
                    <ul class="meta list list-unstyled" style="text-align:center;">
                        ...
                        <li class="my-2"><a href="\Codes\Pizzabites\logout.php"><button class="btn btn-secondary" style="font-size: 15px;padding: 3px 8px;">Logout</button></a></li>
                    </ul>
                </div>
            </div>
