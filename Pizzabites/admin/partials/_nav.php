    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div>
                ...
                <div class="nav__list">
                <a href="\Codes\Pizzabites\signupAdmin.php" class="nav__link">
                      <i class='bx bx-grid-alt nav__icon' ></i>
                      <span class="nav__registration">Registration</span>
                    </a>
                    ...
                    <a href="index.php?page=userManage" class="nav__link nav-userManage">
                      ...
                      <span class="nav__name">Admin & Users' List</span>
                    </a>
            ...
            <a href="\Codes\Pizzabites\logout.php" class="nav__link">
